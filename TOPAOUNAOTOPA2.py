# -*- coding: utf-8 -*-
"""
Created on Wed Jun 15 09:17:42 2016
...
class Tabuleiro:
    ...
    def __init__(self):
        ...
        self.janela.geometry("600x800+20+30")
    ...
    def bt2_onclick(self):
        ...
        self.lby = Label(self.janela,width = 15, fg = "black" , bg = "gold", text = "R$ %d"%self.oferta)
...
class Começo():
     def __init__(self):
        ...
        self.janela1.geometry("400x550+20+30")
